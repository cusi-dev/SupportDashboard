...
SET
	...
	,InboundTicketsCBSWPerc = CASE WHEN m.NewTickets <> 0 THEN m.InboundTicketsCBSW / CAST(m.NewCBSW AS DECIMAL) * 100 ELSE 0 END
	--UMS
	...
	,InboundTicketsUMSPerc = CASE WHEN m.NewTickets <> 0 THEN m.InboundTicketsUMS / CAST(m.NewUMS AS DECIMAL) * 100 ELSE 0 END
FROM
	#MetricsReport m
