class Dashing.FullpieAgent extends Dashing.Widget
    ...
    update: (dataSet) ->
        ...
        dropshadowx = 14                         # X-offset for drop shadow filter
        dropshadowy = 14                         # Y-offset for drop shadow filter
        ...
        path.enter().append('path').attr('class', 'pie').attr('fill', (d, i) -> color i).attr('filter','url(#dropshadow)')
